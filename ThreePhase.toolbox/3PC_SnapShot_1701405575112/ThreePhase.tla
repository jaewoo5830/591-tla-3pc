...
TPSpec == TPInit /\ [][DoNothing]_<<rmState, tmState, tmPrepared, tmCanCommit, rmVote, msgs>>
THEOREM TPSpec => [](TPTypeOK /\ TPConsistent /\ TPLive)
=============================================================================

\* Modification History
\* Last modified Thu Nov 30 23:39:27 EST 2023 by andre
